      ...
      <header className="bg-white/90 backdrop-blur-xl sticky top-0 z-40 shadow-sm border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/profile" className="text-sm font-bold text-slate-700 hidden sm:block bg-slate-100 hover:bg-slate-200 px-4 py-2 rounded-full transition-colors cursor-pointer">
